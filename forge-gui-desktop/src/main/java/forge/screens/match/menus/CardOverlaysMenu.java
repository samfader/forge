...
public final class CardOverlaysMenu {
    ...
    public JMenu getMenu() {
        ...
        menu.add(getMenuItem_CardOverlay(Localizer.getInstance().getMessageorUseDefault("lblPerpetualManaCost", "Perpetual Changes to Mana Cost"), FPref.UI_OVERLAY_CARD_PERPETUAL_MANA_COST));
